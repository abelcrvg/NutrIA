...
const mealFeedbacks = <String, MealFeedback>{
  ...
  'arroz, feijão e carne com ovo e salada': MealFeedback('Prato bastante completo', 'positive', 'Arroz e feijão oferecem uma base de carboidratos e fibras, carne e ovo acrescentam proteínas e a salada amplia a variedade de vegetais.', 'Observe as porções e a quantidade de óleo, molhos e acompanhamentos usados no preparo.'),
  'arroz com frango e legumes': MealFeedback('Boa refeição com vegetais', 'positive', 'O arroz fornece carboidratos, o frango acrescenta proteína e os legumes aumentam a variedade de vegetais e fibras da refeição.', 'Varie os legumes e prefira preparações com quantidade moderada de óleo.'),
  'feijão com arroz e salada': MealFeedback('Base tradicional com vegetais', 'positive', 'O arroz e o feijão combinam carboidratos e fibras, enquanto a salada acrescenta vegetais e amplia a variedade do prato.', 'Inclua uma fonte de proteína conforme o restante da refeição e varie as verduras e legumes.'),
  'cuscuz com ovo e banana': MealFeedback('Café da manhã variado', 'positive', 'O cuscuz fornece carboidratos, o ovo acrescenta proteína e a banana contribui com fibras e micronutrientes.', 'Varie as frutas e considere adicionar vegetais em outras refeições.'),
  'pão integral com ovo e fruta': MealFeedback('Boa combinação para começar o dia', 'positive', 'O pão integral pode contribuir com fibras, o ovo fornece proteína e a fruta amplia a presença de fibras e micronutrientes.', 'Varie as frutas e observe os acompanhamentos e a quantidade de gordura adicionada ao preparo.'),
  'arroz com carne e legumes': MealFeedback('Boa combinação para o almoço', 'positive', 'O arroz fornece carboidratos, a carne acrescenta proteína e os legumes aumentam a variedade de vegetais e fibras da refeição.', 'Varie os legumes e observe a quantidade de óleo utilizada no preparo.'),
  'arroz com feijão e legumes': MealFeedback('Base tradicional com mais vegetais', 'positive', 'Arroz e feijão fornecem carboidratos e fibras, enquanto os legumes ampliam a variedade de vegetais e micronutrientes.', 'Inclua uma fonte de proteína conforme o restante do prato e varie as cores dos legumes.'),
  'frango com batata e salada': MealFeedback('Refeição bem composta', 'positive', 'O frango fornece proteína, a batata contribui com carboidratos e a salada acrescenta vegetais e fibras. A preparação influencia o perfil final.', 'Prefira batata assada ou cozida com frequência e varie os vegetais da salada.'),
  'omelete com tomate e queijo': MealFeedback('Boa fonte de proteína', 'information', 'O ovo e o queijo fornecem proteínas, enquanto o tomate acrescenta vegetal e micronutrientes. A quantidade de queijo pode elevar gordura e sódio.', 'Inclua outros vegetais e ajuste a quantidade de queijo conforme os demais alimentos da refeição.'),
  'cuscuz com frango e ovo': MealFeedback('Refeição prática e proteica', 'positive', 'O cuscuz fornece carboidratos e frango e ovo acrescentam proteínas. A refeição pode ganhar variedade com vegetais.', 'Acrescente legumes ou salada e observe a quantidade de óleo usada no preparo.'),
};
