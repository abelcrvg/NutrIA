  ...
  Widget _dashboard() {
    return ListView(
      ...
      children: [
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text('Bom dia, $_name 👋', style: Theme.of(context).textTheme.titleMedium),
            ...
            CircleAvatar(
              ...
              child: Text(
                ...
                style: const TextStyle(color: NutriTheme.green, fontWeight: FontWeight.w800),
              ),
            ),
          ],
        ),
        ...
        NutrIACard(
          child: Column(
            children: [
              Row(
                children: [
                  const NutrIABadge(text: 'Hoje'),
                  const Spacer(),
                  Text('Meta 2.100 kcal', style: Theme.of(context).textTheme.bodySmall),
                ],
              ),
              const SizedBox(height: 20),
              SizedBox(
        ...
        const _MealTile(
          title: 'Café da manhã',
          description: 'Pão francês com ovo',
          calories: '310 kcal',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('$_water ml registrados hoje'),
                  ],
                ),
              ),
              OutlinedButton(
      ...
      children: [
        ...
        NutrIACard(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const NutrIABadge(text: 'Em breve'),
              const SizedBox(height: 18),
              Text('Histórico e tendências', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800)),
              const SizedBox(height: 8),
              const Text('Gráficos de consumo, frequência de refeições e evolução serão adicionados nesta área.'),
            ],
          ),
        ),
      ],
          ...
          child: Column(
            children: [
              CircleAvatar(
                ...
                child: Text(
                  _name.substring(0, 1).toUpperCase(),
                  style: const TextStyle(fontSize: 25, color: NutriTheme.green, fontWeight: FontWeight.w800),
                ),
              ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: NutriTheme.green),
          ),
          ...
          Text(calories, style: const TextStyle(fontWeight: FontWeight.w800)),
        ],
      ),
    );
  }
